(() => {
  ...
  class Gui {
    constructor(params) {
      ...
      let newButton, renderButton, nextButton, prevButton, deleteButton, resetButton, copyButton, pasteButton, randomizeButton;
      ...
      renderButton = guiAnimation.addButton({title: "Render animation...", disabled: true}).on("click", () => {
  ...
  class Recorder {
    record(mandala2, stage2, config2) {
      ...
      this.pingPong = config2.pingPong;
      this.currentFrame = 0;
      ...
      on(this.gui, "click", ({name}) => {
        switch (name) {
          ...
          case "renderAnimation":
            ...
            this.recorder.record(this.mandala, this.stage, this.config).then(() => this.gui.update());
            break;
          case "randomize":
